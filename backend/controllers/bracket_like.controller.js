...
const createBracketLike = async (req, res) => {
  try {
...
const getBracketLikes = async (req, res) => {
  try {
    const { bracketId } = req.params;
...
const deleteBracketLike = async (req, res) => {
  try {
...
export { createBracketLike, getBracketLikes, deleteBracketLike };
